...
<div class="banner-subpage">
  <div class="banner-image desktop" style="background-image:url('<?php echo $banner_image['url'] ?>')"></div>
  <div class="banner-image mobile" style="background-image:url('<?php echo $home_banner_mobile['url'] ?>')"></div>
